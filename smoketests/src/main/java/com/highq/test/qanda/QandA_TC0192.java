 ...
 * @author vivek.mishra
 */
public class QandA_TC0192 extends BannerPageWeb
{
	 ...
	 */
	@Test
	public void QATC0192() throws InterruptedException, IOException
	{
		preConditions();
		scenario1();
	}
	...
	{
		TC0192_PreConditionsOfUserCreation();
		TC0192_BasicRequirements();
	}
	 ...
	 * @throws IOException
	 */
	private void TC0192_PreConditionsOfUserCreation() throws InterruptedException, IOException
	{
	 ...
	 * @throws IOException
	 */
	private void TC0192_BasicRequirements() throws InterruptedException, IOException
	{
	...
	public void scenario1() throws InterruptedException
	{
		...
		Assert.assertTrue(qAndAWeb.verifyStatusInQuestionListing(question, newStatus));
	}
