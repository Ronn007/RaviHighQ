 ...
 * @author vivek.mishra
 */
public class QandA_TC0194 extends BannerPageWeb
{
	 ...
	 */
	@Test
	public void QATC0194() throws InterruptedException, IOException
	{
		preConditions();
		scenario1();
	}
	...
	{
		TC0194_PreConditionsOfUserCreation();
		TC0194_BasicRequirements();
	}
	 ...
	 * @throws IOException
	 */
	private void TC0194_PreConditionsOfUserCreation() throws InterruptedException, IOException
	{
	 ...
	 * @throws IOException
	 */
	private void TC0194_BasicRequirements() throws InterruptedException, IOException
	{
	...
	public void scenario1() throws InterruptedException
	{
		...
		qAndAWeb.changeTopic(topic[1]);
		qAndAWeb.verifyQuestionInQuestionListing(question);
		Assert.assertTrue(qAndAWeb.verifyTopicInQuestionListing(question, topic[1]));

		qAndAWeb.clickOnQuestion(question);
		qAndAWeb.verifyQADetailContainer();
		qAndAWeb.clickOnShowTagInQADetailContainer();
		Assert.assertTrue(qAndAWeb.verifyTopicValueInQADetailContainer(topic[1]));
		...
		qAndAWeb.clickOnImportTemplateButtonInExportModal();
		...
		////////////// "Here need to verify data from exported file" ///////////

		qAndAWeb.selectOptionInMoreActionInQAPage("Import");
		qAndAWeb.verifyImportModal();
		qAndAWeb.attachFileToBrowseButtonInImportModal(downloadedFile);
		qAndAWeb.clickOnSubmitAnswerCheckBoxInImportModal();
		qAndAWeb.clickOnNextButtonInImportModal();
		qAndAWeb.clickOnNextButtonInImportModal();

		///////////// "Verify data after altered data uploaded" //////////////
